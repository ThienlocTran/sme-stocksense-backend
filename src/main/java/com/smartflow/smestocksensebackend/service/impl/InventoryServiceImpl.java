...
public class InventoryServiceImpl implements InventoryService {
     ...
     * 3. Tìm kiếm bản ghi tồn kho hiện tại (InventoryLevel) theo productId và warehouseId.
    ...
    public void increaseInventory(Long productId, Long warehouseId, Integer quantity) {
        ...
        Optional<InventoryLevel> inventoryLevelOpt = inventoryLevelRepository.findByProductIdAndWarehouseId(productId, warehouseId);
