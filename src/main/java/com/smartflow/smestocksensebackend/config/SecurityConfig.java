        ...
        public SecurityFilterChain securityFilterChain(
                ...
                return http
                                ...
                                .authorizeHttpRequests(authorize -> authorize
                                                ...
                                                .hasAnyRole("ADMIN", "MANAGER", "EMPLOYEE")
                                                .requestMatchers(HttpMethod.GET, "/api/excel-imports/template")
                                                .hasAnyRole("ADMIN", "MANAGER", "EMPLOYEE")
                                                .requestMatchers(HttpMethod.GET, "/api/excel-imports/*/errors")
                                                .hasAnyRole("ADMIN", "MANAGER", "EMPLOYEE")
                                                .requestMatchers(HttpMethod.POST, "/api/excel-imports/*/confirm")
                                                .hasAnyRole("ADMIN", "MANAGER", "EMPLOYEE")
                                                .requestMatchers(HttpMethod.POST, "/api/excel-imports/*/apply")
                                                .hasAnyRole("ADMIN", "MANAGER", "EMPLOYEE")
                                                .requestMatchers(HttpMethod.POST, "/api/excel-imports/*/validate-errors")
                                                .hasAnyRole("ADMIN", "MANAGER", "EMPLOYEE")
                                                ...
                                                .hasAnyRole("ADMIN", "MANAGER")
                                                .requestMatchers(HttpMethod.GET, "/api/system-settings/**")
                                                .hasAnyRole("ADMIN", "MANAGER", "EMPLOYEE")
                                                .requestMatchers(HttpMethod.PUT, "/api/system-settings/**")
                                                .hasAnyRole("ADMIN", "MANAGER")
                                                ...
                                                .requestMatchers(HttpMethod.GET,
                                                                "/api/import-receipts/pending-approval")
                                                .hasAnyRole("ADMIN", "MANAGER")
                                                .requestMatchers(HttpMethod.GET,
                                                ...
                                                .hasAnyRole("ADMIN", "MANAGER")
                                                .requestMatchers(HttpMethod.GET, "/api/import-receipts/*/history")
                                                .hasAnyRole("ADMIN", "MANAGER", "EMPLOYEE")
                                                .requestMatchers(HttpMethod.PUT, "/api/import-receipts/*/approve")
                                                .hasAnyRole("ADMIN", "MANAGER")
                                                .requestMatchers(HttpMethod.PUT, "/api/import-receipts/*/reject")
                                                .hasAnyRole("ADMIN", "MANAGER")
                                                .requestMatchers(HttpMethod.GET, "/api/import-receipts/*")
                                                .hasAnyRole("ADMIN", "MANAGER", "EMPLOYEE")
                                                .requestMatchers(HttpMethod.GET,
                                                ...
                                                .hasAnyRole("ADMIN", "MANAGER")
                                                .requestMatchers(HttpMethod.PUT, "/api/export-receipts/*/complete")
                                                .hasAnyRole("ADMIN", "EMPLOYEE")
