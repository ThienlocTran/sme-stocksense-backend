...
class ImportReceiptUpdateControllerTest {
    ...
    void update_withoutTokenShouldReturn401() throws Exception {
        mockMvc.perform(put("/api/import-receipts/123")
    ...
    void update_employeeOwnerDraftShouldReturnResponse() throws Exception {
        when(importReceiptService.updateEditable(eq(123L), any(SaveImportReceiptDraftRequest.class))).thenReturn(response("NHAP"));
    ...
    void update_employeeOwnerRejectedShouldReturnRejectedStatus() throws Exception {
        when(importReceiptService.updateEditable(eq(123L), any(SaveImportReceiptDraftRequest.class))).thenReturn(response("TU_CHOI"));
    ...
    void update_employeeNonOwnerShouldReturn403() throws Exception {
        when(importReceiptService.updateEditable(eq(123L), any(SaveImportReceiptDraftRequest.class)))
    ...
    void update_nonEditableStatusShouldReturn409() throws Exception {
        when(importReceiptService.updateEditable(eq(123L), any(SaveImportReceiptDraftRequest.class)))
                .thenThrow(new ConflictException("Chi duoc sua phieu nhap o trang thai NHAP hoac TU_CHOI."));
        ...
        mockMvc.perform(put("/api/import-receipts/123")
                ...
                .andExpect(jsonPath("$.message").value("Chi duoc sua phieu nhap o trang thai NHAP hoac TU_CHOI."));
    }
