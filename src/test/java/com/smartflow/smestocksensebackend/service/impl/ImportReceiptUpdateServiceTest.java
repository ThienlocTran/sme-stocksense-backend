...
class ImportReceiptUpdateServiceTest {
    ...
    void update_adminCanEditDraftReceipt() {
        ...
        ImportReceiptDraftResponse response = importReceiptService.saveDraft(123L, minimalRequest());
    ...
    void update_inactiveProductShouldThrow() {
        ...
        assertThrows(BadRequestException.class, () -> importReceiptService.saveDraft(123L, requestWithOneItem()));
    }
    ...
    void update_shouldCalculateLineTotalAndReceiptTotalOnBackend() {
        ...
        importReceiptService.saveDraft(123L, new SaveImportReceiptDraftRequest(
                1L,
                10L,
                null,
