    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/warehouses").hasAnyRole("ADMIN", "MANAGER", "EMPLOYEE")
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/warehouses/*").hasAnyRole("ADMIN", "MANAGER")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/import-receipts/*/approval-detail").hasAnyRole("ADMIN", "MANAGER")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/import-receipts").hasAnyRole("ADMIN", "EMPLOYEE")
