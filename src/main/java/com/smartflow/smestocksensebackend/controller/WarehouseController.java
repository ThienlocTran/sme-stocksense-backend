...
@RequiredArgsConstructor // Tự sinh constructor chứa tham số final để Spring thực hiện cơ chế dependency injection
public class WarehouseController {
     ...
     * Trả về danh sách các kho hàng theo điều kiện tìm kiếm động và lọc trạng thái hoạt động.
     * @param keyword Từ khóa tìm kiếm tùy chọn gửi từ client (tìm kiếm theo mã, tên, địa chỉ kho)
     * @param status Trạng thái lọc tùy chọn gửi từ client (chỉ chấp nhận ACTIVE hoặc INACTIVE)
