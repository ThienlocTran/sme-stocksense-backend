 ...
 * 1. Batch Scan: Quét định kỳ (Cron Job / nút nhấn Dashboard) toàn bộ kho hoặc
 * 1 kho cụ thể.
...
public interface InventoryAlertDetectionService {
     ...
     * @return DTO tổng kết kết quả quét (totalScanned, newAlertsCreated,
     ...
     * @return true nếu phát hiện tụt kho và đã sinh phiếu cảnh báo mới, false nếu
